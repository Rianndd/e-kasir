        ...
        <div class="card-body" bis_skin_checked="1">
            <form action="{{ route('pelanggan.store') }}" method="POST">
                ...
                <div class="mb-3" bis_skin_checked="1">
                    ...
                    <textarea class="form-control" name="alamat" cols="20" placeholder="Masukkan Alamat"></textarea>
                </div>
                <div class="mb-3" bis_skin_checked="1">
                    <label class="form-label" for="basic-default-company">Telepon</label>
                    <input type="number" class="form-control" name="telepon" placeholder="Masukkan Telepon"
                        required>
                </div>
